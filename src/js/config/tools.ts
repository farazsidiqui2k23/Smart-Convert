    ...
    tools: [
      {
        ...
        name: 'Word to PDF',
        icon: 'file-type',
        subtitle: 'Convert Word documents (.docx, .doc) to PDF format.',
      },
      {
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        name: 'PDF to Text',
        icon: 'type',
        subtitle: 'Extract plain text content from PDF documents.',
      },
      {
        href: import.meta.env.BASE_URL + 'pdf-to-html.html',
        name: 'PDF to HTML',
        icon: 'code',
