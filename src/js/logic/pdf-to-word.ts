...
const init = () => {
  ...
  if (convertBtn) {
    convertBtn.addEventListener('click', async () => {
      ...
      await convertToWord(selectedFile);
    });
  }

  async function convertToWord(file: File) {
    try {
      ...
      updateProgress(30, 'Converting to Word...');
      ...
      updateProgress(80, 'Downloading Word file...');
      ...
      setTimeout(() => {
        ...
        showAlert('Success', 'Word document created successfully!');
      }, 1000);
