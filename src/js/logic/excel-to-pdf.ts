...
const init = () => {
  ...
  async function convertToPdf(file: File) {
    try {
      ...
      updateProgress(10, 'Uploading Excel file...');
      ...
      const response = await fetch(`${API_URL}/convert/excel-to-pdf`, {
        method: 'POST',
        body: formData
      });
