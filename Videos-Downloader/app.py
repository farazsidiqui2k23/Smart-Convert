...
#         print(f"📥 Starting download:  {platform} - {url}")
        
#         # Download content
#         result = downloader.download_content(url, download_folder, session_id)
...
#         for url in urls:
#             if url.strip():
#                 result = downloader. download_content(url. strip(), download_folder)
#                 result['url'] = url
